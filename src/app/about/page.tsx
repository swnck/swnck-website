...
export default function Projects() {
    return (
        <>
            <Navbar />
            <div
                className="flex flex-col items-center justify-center relative w-full min-h-screen bg-black text-white py-20">
                <div className="absolute top-24 left-[5%] md:left-[10%]">
                    <p className="font-[VALORANT-FONT] text-[55px] lg:text-[100px]">About</p>
                </div>
                ...
                <section className="pt-10 overflow-hidden   md:pt-0 sm:pt-16 2xl:pt-16">
                    <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
                        <div className="grid items-center grid-cols-1 md:grid-cols-2">
                            ...
                            <div>
                                <h2 className="text-3xl font-bold leading-tight text-black dark:text-white sm:text-4xl lg:text-5xl">Hey
                                    👋 I
                                    am
                    ...
                    <span className="relative inline-block">
                        <span
                            className="absolute inline-block w-full bottom-0.5 h-2 bg-yellow-300 dark:bg-gray-900"></span>
